    ...
    <>
        ...
        <div className='flex flex-col p-6 bg-white rounded-lg'>
          ...
          <div className='grid mt-6 grid-row-2 md:gap-x-5 gap-y-5 lg:grid-cols-3'>
            {/* Image profile*/}
            <div className='bg-indigo-50 rounded-xl sm:mx-0 md:mx-auto col-span-1 self-start'>
            ...
            {/* Form */}
            <form
              className='grid col-span-1  gap-4 mb-3 lg:col-span-2 '
            ...
            >
              ...
              <input
                {...register("address")}
                className='input-form col-span-2 md:col-span-1'
                type='text'
                placeholder='Address'
              />
              <textarea
                {...register("bio")}
                className='w-full pl-3 align-top border rounded-md focus:outline-none focus:border-blueColor col-span-2'
                rows={4}
                placeholder='Bio:'
              />
              <button
                type='submit'
                className='col-[2/3] md:ml-auto px-4 py-3 font-semibold text-white rounded-lg bg-blueColor hover:bg-opacity-90 disabled:bg-opacity-80'
              >
                Add Doctor
              </button>
            </form>
